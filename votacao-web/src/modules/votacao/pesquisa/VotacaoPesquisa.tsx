                        ...
                        <Grid item xs={12} justifyContent={'center'} >
                            <TableContainer component={Paper} style={{margin: '20px'}}>
                                <Table>
                                    <TableHead>
                                        <TableRow>
                                            <TableCell>Votos Favoraveis</TableCell>
                                            <TableCell>Votos Desfavoraveis</TableCell>
                                        ...
                                        <DefaultContent loading={loading}>
                                            <ShowContent show={votacoes?.length > 0}>
                                                <TableRow key={'key-contab'}>
                                                    <TableCell>{contabilizacaoVoto?.votosFavoraveis}</TableCell>
                                                    <TableCell>{contabilizacaoVoto?.votosDesfavoraveis}</TableCell>
                                                    <TableCell>{contabilizacaoVoto?.votosTotais}</TableCell>
                                                </TableRow>
                                            </ShowContent>
                                        </DefaultContent>
                                    </TableBody>
